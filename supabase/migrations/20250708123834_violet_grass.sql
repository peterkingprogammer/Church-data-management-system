/*
  ...
  1. New Tables
    - `users` - User profiles with roles and church information
    ...
    - `attendance` - Attendance tracking for services and events
    - `tasks` - Task assignment and tracking
    - `folders` - Document/content organization
    - `folder_comments` - Comments within folders
    - `follow_ups` - Newcomer follow-up tracking
    - `department_reports` - Department report submissions
    - `subscriptions` - Internal subscription tracking
    - `notices` - Church notices and announcements
    - `excuses` - Member excuse submissions
    - `programs` - Church programs and events
    - `souls_won` - Soul winning records
    - `bible_verses` - Bible verse storage for app
